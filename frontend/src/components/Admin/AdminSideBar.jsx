import { FaBoxOpen, FaClipboardList, FaShopify, FaSignOutAlt, FaStore, FaUser } from "react-icons/fa";
            ...
            <h2 className="text-xl font-medium mb-6 text-center">Admin Dashboard</h2>
                ...
                <div className="mt-6">
                   <button
                    ...
                    className="w-full bg-red-500 hover:bg-red-600 Itext-white py-2 px-4 rounded flex items-center justify-center space-x-2">
                    <FaSignOutAlt />
                    <span>Log Out</span>
                    </button>
                </div>
