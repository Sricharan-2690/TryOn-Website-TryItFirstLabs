...
router.post("/merge",protect,async(req,res)=>{
    ...
    try{
        ...
        if(guestCart){
            ...
            //if user cart alredy present - merge with guest (if prod alredy in usercart inc quantity els push new item)
            if(userCart){
                //merge G - U
                guestCart.products.forEach((guestItem)=>{
                    //check if same exits in  usercart
                    ...
                    //if produc laredy in usercart - upadte quantity
                    if(productIndex>-1){
        ...
        //if no guest cart give his usercart itself
        else{
            if (userCart) {
